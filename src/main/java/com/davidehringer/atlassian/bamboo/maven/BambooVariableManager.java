...
public class BambooVariableManager {
    ...
    public BambooVariableManager(PlanManager planManager, VariableDefinitionManager variableDefinitionManager,
    ...
    public void addOrUpdateVariables(String topLevelPlanKey, List<Variable> variables) {
        Plan plan = planManager.getPlanByKey(PlanKeys.getPlanKey(topLevelPlanKey));
        ...
        for (Variable variable : variables) {
            ...
            if (variableDefinition == null) {
                ...
                buildLogger.addBuildLogEntry("Adding Plan variable " + name + ":" + value);
            } else {
                buildLogger.addBuildLogEntry("Updaing Plan variable from " + name + ":" + variableDefinition.getValue()
                    + " to " + name + ":" + value);
            }
