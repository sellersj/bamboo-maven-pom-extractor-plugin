...
public class CreateOrUpdateVariableMessage extends AbstractBambooAgentMessage {
    ...
    public CreateOrUpdateVariableMessage(String topLevelPlanKey, String buildResultKey, List<Variable> variables) {
    ...
    public Object deliver() {
        ...
        VariableDefinitionManager variableDefinitionManager = getComponent(VariableDefinitionManager.class,
            "variableDefinitionManager");
        BuildLoggerManager buildLoggerManager = getComponent(BuildLoggerManager.class, "buildLoggerManager");
        ...
        BambooVariableManager manager = new BambooVariableManager(planManager, variableDefinitionManager, buildLogger);
