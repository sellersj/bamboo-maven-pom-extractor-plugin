...
public class PomValueExtractorMavenModelTest {
    ...
    @Test
    public void theGAVCanBeExtractedFromAPom() throws IOException, XmlPullParserException {
        File file = getFile("/pom-basic.xml");
        PomValueExtractor extractor = new PomValueExtractorMavenModel(file);
        assertThat(extractor.getValue("groupId"), is("com.davidehringer.bamboo.maven"));
    ...
    public void arrayStyleElementsCanBeExtractedUsingIndexedPropertySyntax()
        ...
        assertThat(extractor.getValue("dependencies[0].groupId"), is("org.apache.maven"));
        assertThat(extractor.getValue("dependencies[0].artifactId"), is("maven-model"));
        assertThat(extractor.getValue("dependencies[0].version"), is("3.0.4"));

        assertThat(extractor.getValue("dependencies[3].groupId"), is("org.hamcrest"));
        assertThat(extractor.getValue("dependencies[3].artifactId"), is("hamcrest-all"));
        assertThat(extractor.getValue("dependencies[3].version"), is("1.1"));
        assertThat(extractor.getValue("dependencies[3].scope"), is("test"));
    }

    @Test
    public void ifAValueIsNotInThePomAnEmptyStringIsReturned() throws IOException, XmlPullParserException {
        File file = getFile("/pom-basic.xml");
        PomValueExtractor extractor = new PomValueExtractorMavenModel(file);
    ...
    @Test
    public void simplePomPropertiesCanBeExtracted() throws IOException, XmlPullParserException {
        File file = getFile("/pom-basic.xml");
        PomValueExtractor extractor = new PomValueExtractorMavenModel(file);
    ...
    @Test
    public void pomPropertiesWithNamesContainingPeriodsCanBeExtractedUsingTheMappedPropertyNotation()
        throws IOException, XmlPullParserException {
        File file = getFile("/pom-basic.xml");
        PomValueExtractor extractor = new PomValueExtractorMavenModel(file);
    ...
    @Test
    public void youCanOnlyGetTheNamesOfModulesAndNotExtractValuesFromTheirActualPoms()
        throws IOException, XmlPullParserException {
